...
CREATE TABLE `Venda` (
  ...
  CONSTRAINT `Venda_ibfk_1` FOREIGN KEY (`id_UsuarioComprador`) REFERENCES `Usuario` (`id`),
  CONSTRAINT `Venda_ibfk_2` FOREIGN KEY (`id_UsuarioVendedor`) REFERENCES `Usuario` (`id`),
  CONSTRAINT `Venda_ibfk_3` FOREIGN KEY (`id_ItemVenda`) REFERENCES `ItensAVenda` (`id`)
